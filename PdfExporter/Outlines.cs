...
{
	/// <summary>
	/// The outlines tree that defines the PDF outline tree
	/// </summary>
	public class Outlines : PDFDictionary
	{
		/// <summary>
		/// Instantitate the outlines object 
		/// </summary>
		public Outlines(): base()
		{
			base.Add (new Name ("Type"), new Name ("Outlines"));			
			base.Add (new Name ("Count"), new Number (0));			
		}
	}
}
