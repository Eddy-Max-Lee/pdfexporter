...
namespace PDFLib.Objects
{
    ...
    {
        public PDFFontDescriptor() : base()		
		{
            base.Add(new Name("Type"), new Name("FontDescriptor"));
        }
        public Name _fontBBox = new Name("FontBBox");
        /// <summary>
        ///  FontBBox
        /// </summary>
        public PDFArray FontBBox
        {
            get
            {
                if (this.Exists(_fontBBox))
                {
                    return (PDFArray)this[_fontBBox];
                }
                else
                {
                    return null;
            ...
            set
            {
                if (this.Exists(_fontBBox))
                {
                    this.Remove(_fontBBox);
                }
                this.Add(_fontBBox, value);
            }
        }
    }
}
